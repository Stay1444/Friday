...
public class MusicPanel : IDisposable
{
    ...
    private MusicModule _musicModuleBase;
    private DiscordMessage? _message;
    private CancellationTokenSource? _cancellationTokenSource;
    private DateTime _lastUpdate = DateTime.MinValue;
    private string? _imageUrl = null;
    private System.Timers.Timer _imgUpdateTimer;
    private MusicPanel(GuildMusic music, DiscordChannel textChannel, MusicModule musicModuleBase)
    {
        this._music = music;
    ...
    public static MusicPanel CreateMusicPanel(GuildMusic music, DiscordChannel textChannel, MusicModule moduleBase)
    {
